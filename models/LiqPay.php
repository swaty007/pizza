...
class LiqPay extends Model
{
    ...
    private $_public_key = 'i15218655318';
    private $_private_key = 'VNfv91WxWyEVfH2FxDn96U2999INDDhkdba7ZEcC';
    ...
    public function cnb_form($params)
    {
        ...
        return sprintf('
            <form id="form" method="POST" action="%s" accept-charset="utf-8">
                %s
                %s
     ...
     */
    public function answerApi ($data)
    {
        $private_key = $this->_private_key;
        $signature = $this->str_to_sign($private_key . $data . $private_key);
        return $signature;
